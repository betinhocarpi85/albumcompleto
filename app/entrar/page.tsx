...
import { signInWithGoogle, signInWithMagicLink, getSession } from '@/lib/db'
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-6">
          ...
          {enviado ? (
            <div className="text-center py-2 animate-fadein">
              ...
              <h2 className="font-black text-slate-800 text-lg mb-2">Verifique seu e-mail</h2>
              <p className="text-sm text-slate-500 mb-1">Enviamos um link de acesso para:</p>
              <p className="font-bold text-slate-800 text-sm mb-5">{email}</p>
              <p className="text-xs text-slate-400 mb-6">
                Clique no link para entrar. Pode fechar esta aba.
              </p>
            ...
            <>
              ...
              <form className="space-y-3" onSubmit={handleSubmit}>
                ...
                <button type="submit" disabled={loading}
                  ...
                  {loading ? (
                    <><span className="w-4 h-4 border-2 border-white/40 border-t-white rounded-full animate-spin" />Enviando link...</>
