          ...
          <form className="space-y-3" onSubmit={e => e.preventDefault()}>
            ...
            <div>
              <div className="flex justify-between mb-1">
                ...
                <a href="#" className="text-xs text-green-600 hover:text-green-700">Esqueceu?</a>
              </div>
              <input
                type="password"
                placeholder="••••••••"
            ...
            <button
              type="submit"
              className="w-full bg-green-500 hover:bg-green-600 text-white font-bold py-3.5 rounded-xl text-sm transition-colors mt-1"
            >
              Entrar
            </button>
          </form>
